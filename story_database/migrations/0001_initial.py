...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ArticleChapterTranslation'
        db.create_table(u'story_database_articlechapter_translation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('headline', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('subheadline', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('quote_attribution', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['story_database.ArticleChapter'])),
        ))
        db.send_create_signal(u'story_database', ['ArticleChapterTranslation'])

        # Adding unique constraint on 'ArticleChapterTranslation', fields ['language_code', 'master']
        db.create_unique(u'story_database_articlechapter_translation', ['language_code', 'master_id'])

        # Adding M2M table for field interactives on 'ArticleChapterTranslation'
        db.create_table(u'story_database_articlechapter_translation_interactives', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('articlechaptertranslation', models.ForeignKey(orm[u'story_database.articlechaptertranslation'], null=False)),
            ('interactive', models.ForeignKey(orm[u'story_database.interactive'], null=False))
        ))
        db.create_unique(u'story_database_articlechapter_translation_interactives', ['articlechaptertranslation_id', 'interactive_id'])

        # Adding model 'ArticleChapter'
        db.create_table(u'story_database_articlechapter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('pano_head', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'story_database', ['ArticleChapter'])

        # Adding M2M table for field related_stories on 'ArticleChapter'
        db.create_table(u'story_database_articlechapter_related_stories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('articlechapter', models.ForeignKey(orm[u'story_database.articlechapter'], null=False)),
            ('articlepage', models.ForeignKey(orm[u'story_database.articlepage'], null=False))
        ))
        db.create_unique(u'story_database_articlechapter_related_stories', ['articlechapter_id', 'articlepage_id'])

        # Adding M2M table for field videos on 'ArticleChapter'
        db.create_table(u'story_database_articlechapter_videos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('articlechapter', models.ForeignKey(orm[u'story_database.articlechapter'], null=False)),
            ('video', models.ForeignKey(orm[u'story_database.video'], null=False))
        ))
        db.create_unique(u'story_database_articlechapter_videos', ['articlechapter_id', 'video_id'])
        ...
        db.create_table(u'story_database_articlepage_translation', (
            ...
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translation', null=True, to=orm['story_database.ArticlePage'])),
        ))
        ...
        # Adding M2M table for field article_chapter on 'ArticlePage'
        db.create_table(u'story_database_articlepage_article_chapter', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('articlepage', models.ForeignKey(orm[u'story_database.articlepage'], null=False)),
            ('articlechapter', models.ForeignKey(orm[u'story_database.articlechapter'], null=False))
        ))
        db.create_unique(u'story_database_articlepage_article_chapter', ['articlepage_id', 'articlechapter_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'ArticleChapterTranslation', fields ['language_code', 'master']
        db.delete_unique(u'story_database_articlechapter_translation', ['language_code', 'master_id'])
        ...
        # Deleting model 'ArticleChapterTranslation'
        db.delete_table(u'story_database_articlechapter_translation')

        # Removing M2M table for field interactives on 'ArticleChapterTranslation'
        db.delete_table('story_database_articlechapter_translation_interactives')

        # Deleting model 'ArticleChapter'
        db.delete_table(u'story_database_articlechapter')

        # Removing M2M table for field related_stories on 'ArticleChapter'
        db.delete_table('story_database_articlechapter_related_stories')

        # Removing M2M table for field videos on 'ArticleChapter'
        db.delete_table('story_database_articlechapter_videos')
        ...
        # Removing M2M table for field article_chapter on 'ArticlePage'
        db.delete_table('story_database_articlepage_article_chapter')
