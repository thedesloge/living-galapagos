...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArticlePage.chpater_graphic'
        db.delete_column(u'story_database_articlepage', 'chpater_graphic')

        # Adding field 'ArticlePage.chapter_graphic'
        db.add_column(u'story_database_articlepage', 'chapter_graphic',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ArticlePage.chpater_graphic'
        db.add_column(u'story_database_articlepage', 'chpater_graphic',
                      self.gf('django.db.models.fields.CharField')(default=500, max_length=200),
                      keep_default=False)

        # Deleting field 'ArticlePage.chapter_graphic'
        db.delete_column(u'story_database_articlepage', 'chapter_graphic')
    ...
    models = {
        u'story_database.articlepage': {
            ...
            'chapter_graphic': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
