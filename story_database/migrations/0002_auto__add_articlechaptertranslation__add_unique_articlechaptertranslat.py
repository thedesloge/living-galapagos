...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'story_database_articlechapter_related_stories', ['articlechapter_id', 'storypage_id'])

        # Adding M2M table for field interactives on 'ArticleChapter'
        db.create_table(u'story_database_articlechapter_interactives', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('articlechapter', models.ForeignKey(orm[u'story_database.articlechapter'], null=False)),
            ('interactive', models.ForeignKey(orm[u'story_database.interactive'], null=False))
        ))
        db.create_unique(u'story_database_articlechapter_interactives', ['articlechapter_id', 'interactive_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field interactives on 'ArticleChapter'
        db.delete_table('story_database_articlechapter_interactives')
    ...
    models = {
        ...
        u'story_database.articlepage': {
            ...
            'article_chapter': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['story_database.ArticleChapter']", 'symmetrical': 'False'}),
            'creation_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
