...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'story_database_menu', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['story_database.Category'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'story_database.menu': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['story_database.Category']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
