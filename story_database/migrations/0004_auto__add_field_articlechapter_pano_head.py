...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleChapter.pano_head'
        db.add_column(u'story_database_articlechapter', 'pano_head',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleChapter.pano_head'
        db.delete_column(u'story_database_articlechapter', 'pano_head')
