...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Menu', fields ['category']
        db.create_unique(u'story_database_menu', ['category_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Menu', fields ['category']
        db.delete_unique(u'story_database_menu', ['category_id'])
