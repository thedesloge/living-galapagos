                    ...
                    if (questions.hasOwnProperty(i)) {
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var imageURL =["images/goat.png","images/iguana.png","images/sealion.png","images/guava.png", "images/tortoise.png", "images/rat.png", "images/penguin.png", "images/raspberries.png", "images/cat.png", "images/donkey.png"];
                                var temImageURL= "";
                                ...
                                var input = '<span class="image' + i + '"><span class="click image"><img src="' + imageURL[answerCount] + '"/></span></span><input id="' + optionId + '" name="' + inputName
                                    + '" type="' + ('radio') + '" />';
            ...
            checkAnswer: function(checkButton) {
                ...
                answerInputs.each( function() {
                    ...
                    if ($('.ui-mobile').length > 0) {
                        ...
                        console.log(" selected label: " + $(this) + " | " + $(this).next('label').html());
                    }
    ...
    $.fn.slickQuiz = function(options) {
        return this.each(function() {
            if (undefined == $(this).data('slickQuiz')) {
                ...
                console.log("thisis in the last function of slickQuiz" + questionArray);
                
                
                    
                $(".image0").click(function () {
                    console.log(questionArray);
                    console.log("#question" + questionArray[currentQuestion] + "_0");
                    console.log("image A was clicked");
                    $(".image0").addClass("selected");
                    $(".image1").removeClass("selected");
                    $("#question" + questionArray[currentQuestion] + "_0").prop('checked',true);
                    });
                    
                $(".image1").click(function () {
                    console.log("image B was clicked");
                    console.log("#question" + questionArray[currentQuestion] + "_1");
                    $(".image0").removeClass("selected");
                    $(".image1").addClass("selected");
                    $("#question" + questionArray[currentQuestion] + "_1").prop('checked',true);
                    });
